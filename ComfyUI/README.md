...
![Stable Diffusion Image Generation Process](./StableDiffusionTerminolpgy-NanoBananaPro.png)
(as generated by [NanoBananaPro](https://blog.google/technology/ai/nano-banana-pro/) using the following prompt: "diagram explaining the process of image generation for stable diffusion using the content of the "Stable Diffusion terminology" table in https://github.com/mmartial/OpenInfra25-GenAI/blob/main/ComfyUI/README.md")
